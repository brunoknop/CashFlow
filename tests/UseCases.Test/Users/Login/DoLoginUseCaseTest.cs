...
public class DoLoginUseCaseTest
{
    ...
    {
        var readRepository = new UserReadOnlyRespoitoryBuilder().GetUserByEmail(user).Build();
        var passwordEncripter = new PasswordEncrypterBuilder().Validate(password).Build();
